                                  ...
                                  <div class="coll-1">
                                     <div class="woocommerce-billing-fields">
                                        ...
                                        <p class="form-row form-row form-row-last validate-required validate-email" id="billing_email_field">
                                           ...
                                           <input type="email" readonly class="input-text " name="email" id="email"  value="{{ Auth::guard('customer')->user()->email }}" />
                                        </p>
                                        <div class="clear"></div>
                                  ...
                                  <table class="shop_table woocommerce-checkout-review-order-table">
                                        ...
                                        <tr class="shipping">
                                           <td data-title="Shipping">
                                            ...
                                            <input id="in" type="radio" class="input-radio delivery_btn" name="delivery_charge" value="80">

                                            <label for="in"> Inside Dhaka (80tk)</label>
                                            <br>
                                            <input id="out" type="radio" class="input-radio delivery_btn" name="delivery_charge" value="120">
                                            <label for="out"> Outside Dhaka (120tk)</label>
                                  ...
                                  <div id="payment" class="woocommerce-checkout-payment py-3 mt-5">
                                     <ul class="wc_payment_methods payment_methods methods">
                                        <li class="wc_payment_method payment_method_cheque mb-2">
                                            <input id="payment_method_ssl" type="radio" class="input-radio" name="payment_method" value="1" data-order_button_text="Proceed to SSL Commerz" />
                                           <!--grop add span for radio button style-->
                                           <span class='grop-woo-radio-style'></span>
                                           <!--custom change-->
                                           <label for="payment_method_ssl">Cash On Delivery</label>
