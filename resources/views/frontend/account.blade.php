                        ...
                        <div class="col-lg-9">
                            <div class="tab-content bg-light p-3" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                    ...
                                    <form action="{{ route('customer.update') }}" method="POST" class="row g-3 p-2">
                                        @csrf
                                        <div class="col-md-6">
                                            <label for="inputnamel4" class="form-label">Name</label>
                                            <input type="text" name="name" class="form-control" id="inputnamel4" value="{{ Auth::guard('customer')->user()->name }}">
                                        </div>
                                        <div class="col-md-6">
