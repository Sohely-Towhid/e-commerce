            ...
            <section class="product_details section_space pb-0">
                <div class="container">
                                ...
                                <div class="details_image_carousel">
                                    @foreach ($product_info->rel_to_thumbnail as $thumb )
                                        <div class="slider_item">
                                            <img src="{{ asset('/uploads/product/thumbnails') }}/{{ $thumb->product_thumbnail}}" alt="image_not_found">
                                        </div>
                                    @endforeach
                        ...
                        <div class="col-lg-6">
                            <div class="product_details_content">
                                ...
                                <div class="item_price">
                                    <span>BDT<span id="price">{{ $product_info->after_discount }}</span></span>
                                    ...
                                    <form action="{{ url('/cart/insert') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 my-3">
                                                ...
                                                @if(App\Models\Inventory::where('product_id',$product_info->id)->where('color_id',$available_colors->first()->color_id)->where('size_id',7)->exists())
                    ...
                    <div class="details_information_tab">
                        <ul class="tabs_nav nav ul_li" role=tableist>
                            <li>
                                    ...
                                    @foreach ($related_product as $related )
                                      <div class="grid col-lg-3">
                                        ...
                                        <div class="details">
                                            ...
                                            <p><a href="{{ route('product.details',$related->id) }}">{{ $related->description }} </a></p>
                                            <div class="rating">
