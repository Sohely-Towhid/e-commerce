...
<body>
                ...
                <div class="cart_sidebar">
                    ...
                    <ul class="cart_items_list ul_li_block mb_30 clearfix">
                        @php
                            $total=0;
                        @endphp
                        @foreach (App\Models\Cart::where('user_id',Auth::guard('customer')->
                        id())->get() as $cart )
                                ...
                                <li>
                                    ...
                                    <div class="item_content">
                                        ...
                                        <span class="item_price">{{ $cart->product->after_discount }} X {{ $cart->quantity }}</span>
                                    </div>
                                    ...
                                    <div class="card card-body">
                                        <ul class="allcategories_list ul_li_block">
                                                 @foreach ( App\Models\Catagory::all() as $catagory )
                                                    ...
                                                    <li><a href="shop_grid.html"><i class="icon icon-Starship"></i> {{ $catagory->catagory_name }}</a></li>
                                                @endforeach
                                        </ul>
                                    </div>
                                </div>
                                 ...
                                 <li>
                                    ...
                                    @auth('customer')
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                          ...
                                          <li><a class="dropdown-item" href="{{ route('customerlogout') }}">Logout</Ol></a></li>
                                        </ul>
                                      </div>
                                        @else
                                        <a href="{{ route('customer.register.from') }}">Login</a>
                    ...
                    <div class="row">
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_about">
                                <div class="brand_logo">
                                    <a class="brand_link" href="index.html">
                                        <img src="{{ asset('front/images/logo/logo_1x.png') }}" alt="logo_not_found">
                                    </a>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_contact">
                                ...
                                <ul class="store_btns_group ul_li">
                                    ...
                                    <li><a href="#!"><img src="{{ asset('front/images/app_store.png') }}" alt="play_store"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{asset('fornt/js/gmaps.min.js')}}""></script> --}}
