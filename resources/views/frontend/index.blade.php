                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="product_details_content">
                                                                                ...
                                                                                <div class="item_price">
                                                                                    <span>BDT{{ $product->after_discount }}</span>
                                            ...
                                            <div class="category_boxed">
                                                <a href="#!">
                                                    <span class="item_image">
                                                        <img src="{{ asset('/uploads/catagory') }}/{{ $catagory->catagory_image }}" alt="image_not_found">
                                                    </span>
                                                    <span class="item_title">{{ $catagory->catagory_name }}</span>
                                                </a>
                                            </div>
                                        </div>
                                    @endforeach
                                ...
                                <div class="widget latest_product_carousel">
                                    ...
                                    <div class="vertical_slider_4item" data-slick='{"dots": false}'>
                                        ...
                                        <div class="slider_item">
                                            <div class="small_product_layout">
                                                <a class="item_image" href="shop_details.html">
                                                    <img src="{{asset('front/images/latest_product/latest_product_5.png')}}" alt="image_not_found">
                                                </a>
                                                <div class="item_content">
                                                    <h3 class="item_title">
                                                        <a href="shop_details.html">Product Sample</a>
                                        ...
                                        <div class="details">
                                            ...
                                            <span class="price">
                                                <ins>
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi>
                                                            <span class="woocommerce-Price-currencySymbol">BDT</span></span>{{ $new->after_discount}}
                                                        </bdi>
                                                    </span>
                                                </ins>
                                            </span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="product_details_content ps-3">
                                                ...
                                                <div class="item_price">
                                                    <span>BDT{{ $new->after_discount }}</span>
                                                    <del>BDT{{ $new->product_price }}</del>
                                                </div>
                                                <hr>
                                                <div class="item_attribute">
                                                    <h3 class="title_text">Options <span class="underline"></span></h3>
